...
1. **Extend BaseIT**:
   Always extend [BaseIT](src/test/java/com/reporting/BaseIT.java). This handles starting the Testcontainers PostgreSQL DB or falling back to the local database, applying migrations, and loading properties.
