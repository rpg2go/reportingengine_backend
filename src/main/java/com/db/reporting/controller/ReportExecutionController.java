...
import com.db.reporting.service.SqlGeneratorService;
import com.db.reporting.service.PostProcessorService;
...
public class ReportExecutionController {
    ...
    public ResponseEntity<?> executeReport(
        ...
        try {
            ...
            // 4. Run database query via dispatcher
            List<Map<String, Object>> rawData = analyticsQueryDispatcher.queryForList(sql);
