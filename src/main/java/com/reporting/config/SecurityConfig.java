...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(PasswordEncoder passwordEncoder) {
        String adminUsername = env.getProperty("SECURITY_ADMIN_USERNAME");
        if (adminUsername == null || adminUsername.isBlank()) {
            adminUsername = "admin";
        }
        String adminPassword = env.getProperty("SECURITY_ADMIN_PASSWORD");
        if (adminPassword == null || adminPassword.isBlank()) {
            adminPassword = UUID.randomUUID().toString();
            log.info("------------------------------------------------------------");
            log.info("SECURITY CONFIGURATION WARNING: SECURITY_ADMIN_PASSWORD is not configured.");
