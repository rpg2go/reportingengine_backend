...
public class ReportRunnerServiceIT extends BaseIT {
    ...
    public void runReport_validConfig_shouldGeneratePopulatedExcelSheet() throws Exception {
        ...
        List<ReportRowDto> rows = List.of(
            new ReportRowDto("R1", reportId, "Revenue Row", Enums.RowType.data, "total_revenue", null, "normal", 0, 1, Set.of("C1"), null),
            new ReportRowDto("R2", reportId, "Double Revenue", Enums.RowType.calc, "R1 * 2", null, "total", 0, 2, Set.of("C1"), null)
        );
