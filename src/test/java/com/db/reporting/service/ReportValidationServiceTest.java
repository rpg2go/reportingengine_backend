...
import com.db.reporting.catalog.MetaRelationship;
...
public class ReportValidationServiceTest {
    ...
    public void validate_circularReferenceThrowsCircularReferenceException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(com.db.reporting.exception.CircularReferenceException.class, () -> {
